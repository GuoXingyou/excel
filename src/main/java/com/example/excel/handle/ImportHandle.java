...
public class ImportHandle {
     ...
     * @throws IOException
     */
    public ImportHandle(String fileName, int headerNum)
     ...
     * @throws IOException
     */
    public ImportHandle(File file, int headerNum)
            throws InvalidFormatException, IOException {
     ...
     * @throws IOException
     */
    public ImportHandle(String fileName, int headerNum, int sheetIndex)
            throws InvalidFormatException, IOException {
     ...
     * @throws IOException
     */
    public ImportHandle(File file, int headerNum, int sheetIndex)
            throws InvalidFormatException, IOException {
     ...
     * @throws IOException
     */
    public ImportHandle(MultipartFile multipartFile, int headerNum, int sheetIndex)
            throws InvalidFormatException, IOException {
     ...
     * @throws IOException
     */
    public ImportHandle(String fileName, InputStream is, int headerNum, int sheetIndex)
            throws InvalidFormatException, IOException {
    ...
    public <E> List<E> getDataList(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException {
        ...
        for (Field f : fs) {
            Excel ef = f.getAnnotation(Excel.class);
            if (ef != null && (ef.type().equals(OperationType.BOTH)|| ef.type().equals(OperationType.ONLY_IMPORT))) {
        ...
        for (Method m : ms) {
            Excel ef = m.getAnnotation(Excel.class);
            if (ef != null && (ef.type().equals(OperationType.BOTH)|| ef.type().equals(OperationType.ONLY_IMPORT))) {
                if (groups != null && groups.length > 0) {
                    if(groups.length > 1 ){
                        throw new RuntimeException("一次操作只能存在一个分组.");
